...
class Api_Canciones_Controller extends Base_Controller {
    ...
    public function get_index($id = null) 
    {
        ...
        if (is_null($id )) 
        {
        	$cancion = Cancion::join('generos', 'canciones.idgenero', '=', 'generos.id')->join('bandas', 'canciones.idbanda', '=', 'bandas.id')->left_join('letras', 'canciones.id', '=', 'letras.idcancion')->get(array('canciones.*', 'generos.nombre as genero', 'bandas.nombre as banda', 'bandas.urltag as banda_urltag', 'letras.id as idletra'));
